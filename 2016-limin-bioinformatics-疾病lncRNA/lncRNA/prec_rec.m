function [prec,recc,f1_score, tpr, fpr, thresh] = prec_rec(score, target, varargin)
...
if (plot_pr || plot_roc)
    ...
    if (~hold_fig)
        ...
        if (plot_pr)
            ...
            plot([0; recc], [1 ; prec], style); % add pseudo point to complete curve
        ...
        if (plot_roc)
            ...
            title('roc curve');
            [stack_x,stack_y,thre,auc]=perfcurve(target,score,1);
